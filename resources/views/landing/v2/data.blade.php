                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <ul class="list_none blog_meta">
                                    <li><a href="#"><i class="ion-calendar"></i> {{ $dataFile->created_at->format('d F Y') }}</a></li>
                                ...
                                @if ($dataFile->akses == 'public')
                                    <a href="{{ config('isec.base_url') }}/data/download/{{ $dataFile->id_data_file_encrypt }}" class="btn btn-xs btn-primary">
                                        Download
                                    </a>
                                    ...
                                    <div id="accordion" class="accordion">
                                        <div class="card">
                                            <div class="card-header" id="headingOne">
                                                <h6 class="mb-0"> <a data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Instansi</a> </h6>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingTwo">
                                                <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Klasifikasi</a> </h6>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingThree">
                                                <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Information</a> </h6>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingThree">
                                                <h6 class="mb-0">
                                                    <a class="collapsed" data-toggle="collapse" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">Download File</a>
